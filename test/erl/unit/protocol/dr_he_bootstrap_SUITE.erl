...
%% growth (extra fields, padding) is caught at test time. 5276 bytes equals
...
%% 8-byte magic/version/size tag at the head of the blob.
...
dr_state_size_pinned(_Config) ->
    ...
    ?assertEqual(5276, byte_size(Alice)).
